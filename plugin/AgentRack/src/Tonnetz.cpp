...
struct TonnetzPanel : rack::widget::Widget {
    ...
    void draw(const DrawArgs& args) override {
        ...
        nvgTextAlign(vg, NVG_ALIGN_CENTER | NVG_ALIGN_MIDDLE);
        nvgText(vg, mm2px(AgentLayout::OUTER_LEFT_COLUMN_12HP),  mm2px(AgentLayout::TOP_IO_ROW_12HP - 4.f), "CV1", nullptr);
        nvgText(vg, mm2px(AgentLayout::CENTER_12HP),             mm2px(AgentLayout::TOP_IO_ROW_12HP - 4.f), "CV2", nullptr);
        nvgText(vg, mm2px(AgentLayout::OUTER_RIGHT_COLUMN_12HP), mm2px(AgentLayout::TOP_IO_ROW_12HP - 4.f), "CV3", nullptr);
        nvgText(vg, mm2px(AgentLayout::LEFT_COLUMN_12HP),        mm2px(AgentLayout::BOTTOM_IO_ROW_12HP - 4.f), "TRG", nullptr);
        nvgText(vg, mm2px(AgentLayout::RIGHT_COLUMN_12HP),       mm2px(AgentLayout::BOTTOM_IO_ROW_12HP - 4.f), "OUT", nullptr);
    }
};
...
struct TonnetzWidget : rack::ModuleWidget {
    ...
    TonnetzWidget(Tonnetz* module) {
        ...
        addInput(createInputCentered<PJ301MPort>(
            mm2px(Vec(AgentLayout::OUTER_LEFT_COLUMN_12HP, AgentLayout::TOP_IO_ROW_12HP)), module, Tonnetz::CV1_INPUT));
        addInput(createInputCentered<PJ301MPort>(
            mm2px(Vec(AgentLayout::CENTER_12HP, AgentLayout::TOP_IO_ROW_12HP)), module, Tonnetz::CV2_INPUT));
        addInput(createInputCentered<PJ301MPort>(
            mm2px(Vec(AgentLayout::OUTER_RIGHT_COLUMN_12HP, AgentLayout::TOP_IO_ROW_12HP)), module, Tonnetz::CV3_INPUT));

        // TRG / OUT row
        addInput(createInputCentered<PJ301MPort>(
            mm2px(Vec(AgentLayout::LEFT_COLUMN_12HP, AgentLayout::BOTTOM_IO_ROW_12HP)), module, Tonnetz::TRIG_INPUT));
        addOutput(createOutputCentered<PJ301MPort>(
            mm2px(Vec(AgentLayout::RIGHT_COLUMN_12HP, AgentLayout::BOTTOM_IO_ROW_12HP)), module, Tonnetz::CHORD_OUTPUT));
    }
};
