...
def build() -> str:
    ...
    ladder  = pb.module(AR, "Ladder", position=bottom_row.at(58), Cutoff=10.0, Resonance=0.15, Spread=0.1)
    saphire = pb.module(AR, "Saphire", position=bottom_row.at(70), Mix=0.35, Time=0.5, Bend=0.0, Tone=0.7)
