...
def build() -> str:
    ...
    lfo = pb.module(FUN, "LFO", pos=top_row.at(34), Frequency=-1.2, Offset=0)   # Offset=0 = bipolar ±5V
    ...
    att = pb.module(AR, "Attenuate", pos=top_row.at(42), Scale_1=0.4)    # 5V * 0.4 = 2V swing → ±0.2 timbre
    ...
    filt = pb.module(AR, "Ladder", pos=voice_row.at(38), Cutoff=0.55, Resonance=0.3)
